...
<br/>
<center> <table id="editsubmitbuttons">
 <tr>
 <td><button type="button" class="btn btn-primary btn-md" style="margin-right: 10px;" onclick="return onEditlockMaster();">Edit</button></td>
 <td><button type="button" class="btn btn-primary btn-md" onclick="return onSubmitlockMaster();" type="submit" >Save</button></td>
 
 	<!-- <td ><button style="margin-left: 10px;" class="button  bg-cyan bg-active-darkBlue fg-white" onclick="return onEditlockMaster();" value="Edit" /><span class="mif-pencil"></span>&nbsp;Edit</td>
 	<td ><button class="button  bg-cyan bg-active-darkBlue fg-white" onclick="return onSubmitlockMaster();" type="submit" value="Save" /><span class=" mif-cloud-upload "></span>&nbsp;Save</td> -->
 </tr>
 </table></center>
 <br/><br/>
 </div>
