...
function onSubmitProcWap()
{
	...
	if(confirm('Are You Sure You Want To Process WAP For '+mth+'?')){
		on();	
...
<div id="locktable" >
<h5>Select Month for Which WAP is to be Processed For Whole Field Force:</h5> 
...
<tr>
	<td>
		<select class="col-lg-8 form-control" id="yrMth" name="yrMth" onchange="removeError()" >
			<option value="">Select Month for WAP Processing</option>
			<c:forEach items="${finYrMonthsMap}" var="monthyr">
				<c:choose>
	...
	<td ><!-- id="editsubmitbuttons" -->
		<button id="confirm" type="submit"  class="btn btn-primary col-lg-6" onclick="return onSubmitProcWap();">&nbsp;&nbsp;Process&nbsp;&nbsp;</button>
	</td>
</tr>
</table>
<%-- FOR TESTING 
