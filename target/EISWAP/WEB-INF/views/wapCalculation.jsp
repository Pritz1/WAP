...
<title>WAP Calculation Example</title>
<script>
function wapCal(val){
...
<div id="example" >
 <div class="accordion" data-role="accordion">
                        <!-- <h5>.accordion with icon</h5> -->
                            ...
                            <li>This option lets you to calculate WAP score by changing acheivement</li>
                            ...
                            <div class="frame ">
                                <div class="heading">WAP Calculation<span class="mif-cog icon"></span></div>
                                ...
                                <li>WAP : is calculated based on the weightage of each parameter. (Weightage is set through PARAMETER menu)</li>
                                <li>Formula for WAP=score*(weightage/100)</li>
								<li>Rating : Based on WAP calculated rating is decided.</li>
