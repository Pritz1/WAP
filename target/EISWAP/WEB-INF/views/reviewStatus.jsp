...
<table cellspacing="0" data-field="EMP" data-toggle="table" class="table col-lg-12 table-striped table-hover borderless" data-search="true"  width="100%">
				<thead>
					<tr>
					    <th width="10%" data-sortable="true" ><div><span>EMP CODE</span></div></th>
					    <th width="15%" data-sortable="true"><div><span>PSR</span></div></th>
						<th width="15%" data-sortable="true"><div><span>HQ NAME</span></div></th>
						<th width="15%" data-sortable="true"><div><span>MANAGER REVIEWAL</span></div></th>
						<th width="15%" data-sortable="true"><div><span>UPPER LEVEL REVIEWAL</span></div></th>
				...
				<c:forEach items="${reviewStatus.empList}" var="emp">
	 			 <tr>
					...
					<td>${emp.hname}</td>
					<c:choose>
<c:when test="${emp.mgr1Emp!=null or not empty emp.mgr1Emp}">
...
<td>PENDING</td>
 					...
 					<c:choose>
<c:when test="${emp.mgr2Emp!=null or not empty emp.mgr2Emp}">
<td class="green">COMPLETED</td>
</c:when>
<c:otherwise>
<td>PENDING</td>
